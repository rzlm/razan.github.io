...
const Hero = () => {
  return (
    ...
    <h1
        class="relative top-0 w-fit h-auto py-4 justify-center flex bg-gradient-to-r items-center from-purple-500 via-blue-300 to-purple-400 bg-clip-text text-6xl font-extrabold text-transparent text-center select-auto">
        Razan Mohamed
    </h1>
      </div>
      <div className='  '>
      <h1
        class="relative top-0 w-fit h-auto py-2 justify-center flex bg-gradient-to-r items-center from-purple-400 via-blue-200 to-purple-200 bg-clip-text text-3xl font-extrabold text-transparent text-center select-auto">
